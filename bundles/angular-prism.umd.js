(function (global, factory) {
	...
	(factory((global['angular-prism'] = {}),global.ng.core,global.ng.common));
...
var CodeblockComponent = /** @class */ (function () {
     ...
     * @param {?} elementRef
     */
    function CodeblockComponent(elementRef) {
    ...
    CodeblockComponent.prototype.ngOnInit = function () {
        console.info('Prism.languages =', undefined);
    };
    /**
     * @return {?}
     */
    CodeblockComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        var /** @type {?} */ tc = new DOMParser()
            .parseFromString(this.elementRef.nativeElement.innerHTML, 'text/html')
            .documentElement.innerText;
        if (this.reduce_indent) {
            tc = tc.split('\n')
                .map(function (s) { return s.search(/\S/) >= _this.reduce_indent ?
                s.substr(_this.reduce_indent) : s; })
                .join('\n');
        }
        this.elementRef.nativeElement.innerHTML = "<pre><code>" + undefined(tc, undefined[this.lang]) + "</code></pre>";
    };
...
//# sourceMappingURL=angular-prism.umd.js.map
